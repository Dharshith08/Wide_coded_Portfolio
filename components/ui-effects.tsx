...
export default function UiEffects() {
  ...
  return (
    <>
      <motion.div
        aria-hidden
        className="pointer-events-none fixed left-0 top-0 z-[2] h-[360px] w-[360px] rounded-full bg-accent/10 blur-3xl"
        style={{ x, y }}
      />
      <div
        aria-hidden
        className="pointer-events-none fixed inset-0 z-[1] opacity-[0.2]"
        style={{
          backgroundImage:
